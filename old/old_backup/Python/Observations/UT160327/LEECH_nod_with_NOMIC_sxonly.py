...
pi.setINDI("LMIRCAM.Command.text","40 obssequences",timeout=300,wait=True)
for j in range(10):
	print j
	...
	pi.setINDI("LMIRCAM.Command.text","go",timeout=300,wait=False)
	...
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", 0.0, "LBTO.OffsetPointing.OffsetY", -4.5, "LBTO.OffsetPointing.Side", "left", "LBTO.OffsetPointing.Type", "REL")
	pi.setINDI("NOMIC.Command.text","rawbg")
