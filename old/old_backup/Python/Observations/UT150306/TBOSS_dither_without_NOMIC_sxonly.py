...
pi.setINDI("LMIRCAM.Command.text","30 obssequences",timeout=300,wait=True)
for j in range(1):
	print j
	...
	#POSITION TOP LEFT
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", -2.0, "LBTO.OffsetPointing.OffsetY", 0.0, "LBTO.OffsetPointing.Side", "left", "LBTO.OffsetPointing.Type", "REL",timeout=400) 
	...
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", 0.0, "LBTO.OffsetPointing.OffsetY", -3.0, "LBTO.OffsetPointing.Side", "left", "LBTO.OffsetPointing.Type", "REL",timeout=400) 
