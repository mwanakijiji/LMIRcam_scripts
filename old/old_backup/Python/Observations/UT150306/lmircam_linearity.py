...
#set and obstype filters to flat
#pi.setINDI("Lmir.LMIR_FW2.command", "L-cont4", timeout=20, wait=True)
#pi.setINDI("Lmir.LMIR_FW4.command", "Open", timeout=20, wait=True)
...
#set filters and datatype to dark
...
#turn off save data
pi.setINDI("NOMIC.Command.text", "0 savedata 1 autodispwhat 1 loglevel", wait=True)
