...
for j in range(1):
	...
	#POSITION TOP LEFT
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", -4.0, "LBTO.OffsetPointing.OffsetY", 0.0, "LBTO.OffsetPointing.Side", "right", "LBTO.OffsetPointing.Type", "REL",timeout=400) 
	...
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", 0.0, "LBTO.OffsetPointing.OffsetY", -4.0, "LBTO.OffsetPointing.Side", "right", "LBTO.OffsetPointing.Type", "REL",timeout=400) 
