...
pi.setINDI("LMIRCAM.Command.text","12 obssequences",timeout=300,wait=True)
for j in range(10):
	print j
	...
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", 4.0, "LBTO.OffsetPointing.OffsetY", -4.0, "LBTO.OffsetPointing.Side", "left", "LBTO.OffsetPointing.Type", "REL") 
#---
        wait4AORunning()
