...
#ES Jan 6, 2015-- changed the vectors to do two-point dithers for a single target, where the target needs to appear in the second and fourth quadrants, 3 arsec from the edge
...
pi.setINDI("LMIRCAM.Command.text","10 obssequences",timeout=300,wait=True) # edited
for j in range(30):
	print j
	...
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", 4.0, "LBTO.OffsetPointing.OffsetY", -4.0, "LBTO.OffsetPointing.Side", "both", "LBTO.OffsetPointing.Type", "REL") 
#---
        wait4AORunning()
