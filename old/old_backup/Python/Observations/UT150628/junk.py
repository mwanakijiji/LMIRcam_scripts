...
pi.setINDI("Lmir.LMIR_FW2.command", "_home_", timeout=300, wait=True) # 'home' is the same as 'Open'
pi.setINDI("Lmir.LMIR_FW3.command", "_home_", timeout=300, wait=True)
pi.setINDI("Lmir.LMIR_FW4.command", "H2O-Ice2", timeout=300, wait=True)
...
pi.setINDI("Lmir.LMIR_FW2.command", "_home_", timeout=300, wait=True)
pi.setINDI("Lmir.LMIR_FW3.command", "Lcont1", timeout=300, wait=True)
pi.setINDI("Lmir.LMIR_FW4.command", "_home_", timeout=300, wait=True)
...
pi.setINDI("Lmir.LMIR_FW2.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW3.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW4.command", "N03309-8", timeout=40, wait=True)
#pi.setINDI("LMIRCAM.EditFITS.Keyword=FLAG;Value=FLT;Comment=SCI/CAL/DRK/FLT")
...
pi.setINDI("Lmir.LMIR_FW2.command", "L-cont2", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW3.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW4.command", "_home_", timeout=40, wait=True)
#pi.setINDI("LMIRCAM.EditFITS.Keyword=FLAG;Value=FLT;Comment=SCI/CAL/DRK/FLT")
...
pi.setINDI("Lmir.LMIR_FW2.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW3.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW4.command", "Lcont3", timeout=40, wait=True)
#pi.setINDI("LMIRCAM.EditFITS.Keyword=FLAG;Value=FLT;Comment=SCI/CAL/DRK/FLT")
...
pi.setINDI("Lmir.LMIR_FW2.command", "L-cont4", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW3.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW4.command", "_home_", timeout=40, wait=True)
#pi.setINDI("LMIRCAM.EditFITS.Keyword=FLAG;Value=FLT;Comment=SCI/CAL/DRK/FLT")
...
pi.setINDI("Lmir.LMIR_FW2.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW3.command", "_home_", timeout=40, wait=True)
pi.setINDI("Lmir.LMIR_FW4.command", "Br-Alpha-On", timeout=40, wait=True)
#pi.setINDI("LMIRCAM.EditFITS.Keyword=FLAG;Value=FLT;Comment=SCI/CAL/DRK/FLT")
