...
for j in range(nod_pairs_per_filter):
  ...
  # nod down       
  pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", x_nod_amplitude, "LBTO.OffsetPointing.OffsetY", -y_nod_amplitude, "LBTO.OffsetPointing.Side", "left", "LBTO.OffsetPointing.Type", "REL", timeout=400) 
