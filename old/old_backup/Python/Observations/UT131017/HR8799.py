...
#    pi.waitINDI(["NOMIC.Command.text"],timeout=100)
    ...
    #NOD down 4"
    pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", 0, "LBTO.OffsetPointing.OffsetY", -4.0, "LBTO.OffsetPointing.Side", "both", "LBTO.OffsetPointing.Type", "REL") 
