...
#LMIRCam filter 5
pi.setINDI("Lmir.LMIR_FW2.command", "L-cont3", timeout=20)
...
pi.setINDI("LMIRCAM.Command.text", "1.5 1 33 lbtintpar 500 sleep", timeout=15)
pi.setINDI("LMIRCAM.Command.text","go",timeout=100,wait=False)
...
#LMIRCam filter 7
pi.setINDI("Lmir.LMIR_FW2.command", "N03946-4", timeout=20)

pi.setINDI("LMIRCAM.Command.text", "0.1 10 1 lbtintpar 500 sleep", timeout=15)
pi.setINDI("LMIRCAM.Command.text","go",timeout=100)

pi.setINDI("LMIRCAM.Command.text", "0.7 1 71 lbtintpar 500 sleep", timeout=15)
pi.setINDI("LMIRCAM.Command.text","go",timeout=100,wait=False)
