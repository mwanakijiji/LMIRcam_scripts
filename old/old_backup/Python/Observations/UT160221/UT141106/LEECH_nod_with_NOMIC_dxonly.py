...
for j in range(10):
	...
	pi.setINDI("LBTO.OffsetPointing.CoordSys", "DETXY","LBTO.OffsetPointing.OffsetX", 0.0, "LBTO.OffsetPointing.OffsetY", -3.0, "LBTO.OffsetPointing.Side", "right", "LBTO.OffsetPointing.Type", "REL")
