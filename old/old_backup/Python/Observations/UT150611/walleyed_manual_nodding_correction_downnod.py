...
#################################################
## take down nod only, and don't save the file ##
#################################################
...
for k in range(3): # do three iterations to get back to the original position
	...
	# start diagnostic to see current values
	print 'Starting values:'
	print tipFPC
	print tiltFPC
	print pistonFPC
	# end diagnostic to see current values


	xDispPixL = current_cx_L - orig_DL_x
	yDispPixL = current_cy_L - orig_DL_y
	...
	# start diagnostic to see if correction actually went through
	...
	xDispPixR = current_cx_R - orig_DR_x
	yDispPixR = current_cy_R - orig_DR_y
