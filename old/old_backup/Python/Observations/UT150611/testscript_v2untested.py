...
datadir = '/home/observer/data/'+day+'_walleyed/'
...
Lint = 0.029  # integration in [sec]; needs to be multiples of 0.029 sec
...
#    pi.setINDI("LMIRCAM.Command.text", str(Lint)+" "+str(Lcoadd)+" "+str(Lseq)+" lbtintpar 500 sleep", wait=True) # this is commented, to see if parameters can just be set in the GUI
