...
testLMIR = True     # True or False. If true, do not actually configure LMIRCam or take new images
print 'testLMIR ='
print testLMIR
...
#newtipFPC = -0.0002 # diagnostic

sys.exit()

#### set needed relative shifts
mode = 1; # 1 = relative to current; 0 = absolute
#newsettingsFPC = settingsFPC # don't do this! causes a mixture
newsettingsFPC=[]
newsettingsFPC['Acromag.FPC.Tip'] = newtipFPC;        # up/down, arc seconds
newsettingsFPC['Acromag.FPC.Tilt'] = newtiltFPC;      # left/right, arc seconds
#newsettingsFPC['Acromag.FPC.Piston'] = newpist;    # in/out, microns
newsettingsFPC['Acromag.FPC.Mode'] = mode;         # 0 = absolute, 1 = relative to current
#newsettingsSPC['Acromag.SPC.Tip'] = newtipSPC;        # up/down, arc seconds
#newsettingsSPC['Acromag.SPC.Tilt'] = newtiltSPC;      # left/right, arc seconds
#newsettingsSPC['Acromag.SPC.Mode'] = mode;         # 0 = absolute, 1 = relative to current
#current 
...
# check if the status went through
settingsFPC  = pi.getINDI('Acromag.FPC_status.*')
