...
#################################################
#camera
dit = 1100              #  What integration time (millisec), will be set by server to closest possible integration time of the camera, which depends on setup.
coadds = 1             #  this should probably be 1
nseqs = 150             #  How many frames per nod?
...
N_cycles = 15          #  How many nodding cycles should be executed by this script with a single execution?
