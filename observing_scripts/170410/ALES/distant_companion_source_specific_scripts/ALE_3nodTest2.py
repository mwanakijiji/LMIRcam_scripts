...
primary_RA =  [10,19,58.43]
primary_Dec = [19,50,28.54]
#from Ginski 2013
secondary_sep = 4.560
secondary_PA = 126.6
...
def do_exposures(Lintparams,Nintparams,flag,RAOff,DecOff):
    pi.setINDI("LMIRCAM.Command.text", "0 contacq", wait=True)
...
for j in range(10):
    ...
    print 'DO PRIMARY ', j
    print
    do_exposures(plightIntParams,NplightIntParams,'PRI',priRAOff,priDecOff)
...
# NOD TO SECONDARY
    ...
    print
    do_exposures(slightIntParams,NslightIntParams,'SEC',secRAOff,secDecOff)
# NOD TO SKY
    print 'Get Sky ', j
    print
    ...
    print 'begin Sky ', j
    print
    do_exposures(slightIntParams,NslightIntParams,'SKY',skyRAOff,skyDecOff)
