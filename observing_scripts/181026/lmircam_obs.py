...
#################################################
#camera
dit = 90              #  What integration time (millisec), will be set by server to closest possible integration time of the camera, which depends on setup.
coadds = 2             #  this should probably be 1
nseqs = 5             #  How many frames per nod?
