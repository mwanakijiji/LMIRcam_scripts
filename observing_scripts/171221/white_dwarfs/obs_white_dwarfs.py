...
#
# Instructions:
# - Use the full, unvigneted FoV, single sided observations, H band.
# - Targets are faint, be aware of the long integration times and potential AO problems.
# - Center the star in the lower-left corner of the FoV.
...
#camera
dit_bkg = 5          # DIT for background and source positioning. May need updating based on source brightness.
...
nod_y = 6            # arcseconds in detector coords, might need updating
...
x_dither = [0.0, 0.05, 0.0, 0.0,  0.0, -0.05, 0.0]
y_dither = [0.0, 0.0,  0.0, 0.05, 0.0, 0.0,   0.0]
