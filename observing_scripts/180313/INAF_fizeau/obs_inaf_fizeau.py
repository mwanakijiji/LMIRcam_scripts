...
#from lmircam_tools.track_fizeau import track_spectral_fringes
...
ndit_fringes = 1000  # Number of integrations per nod on fringes.
ndit_spec = 100      # Number of integrations per nod on not overlapped spectra.
...
# bands
do_lband = False      # take L band data? (True/False)
...
#  align_spec(nod_pos = nod_pos)
  ...
  print ''
  request('Please make sure fringes are upright.')
  print '  Hit [RETURN] when done.'; raw_input()
