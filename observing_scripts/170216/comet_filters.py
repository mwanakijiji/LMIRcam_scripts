...
#Lp
pi.setINDI("LMIRCAM.Command.text", "%f 1 %i lbtintpar" % (1, 100), timeout=1000)
...
#Lshort
pi.setINDI("LMIRCAM.Command.text", "%f 1 %i lbtintpar" % (2, 50), timeout=1000)
pi.setINDI("Lmir.lmir_FW3.command", 'Open', timeout=45, wait=True)
pi.setINDI("Lmir.lmir_FW4.command", 'Lshort', timeout=45, wait=True)
pi.setINDI("LMIRCAM.Command.text", "go", timeout=600, wait=True)
#Ice
pi.setINDI("LMIRCAM.Command.text", "%f 1 %i lbtintpar" % (4, 25), timeout=1000)
pi.setINDI("Lmir.lmir_FW3.command", 'Open', timeout=45, wait=True)
