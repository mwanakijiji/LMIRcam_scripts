...
ndit_fringes = 500   # Number of integrations per nod on fringes.
...
track_fringes = True # Track fringes? Can be True' or 'False'.
sleep_cont = 0.5     # Extra sleep time after stopping continuous acquisition (s).

# telesecope
nod_x = 1.4          # arcseconds in detector coords
